...
//]]>
	...
	<form method="post" action="{$link->getPageLink('products-comparison')}" onsubmit="true" class="pull-right">
		<p>
		<input type="submit" id="bt_compare" class="btn" value="{l s='Compare'}" />
