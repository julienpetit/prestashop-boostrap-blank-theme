...
<div id="layered_block_left" class="block well-white">
	<h4 class="block-title">{l s='Catalog' mod='blocklayered'}</h4>
	<div class="block_content">
		<form action="#" id="layered_form">
			<fieldset>
				{if isset($selected_filters) && $n_filters > 0}
				<div id="enabled_filters">
					<legend class="layered_subtitle" style="float: none;">{l s='Enabled filters:' mod='blocklayered'}</legend>
					<ul>
