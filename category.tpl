...
{if isset($category)}
	{if $category->id AND $category->active}
		...
		<div class="resumecat alert alert-info category-product-count">
			{include file="$tpl_dir./category-count.tpl"}
		</div>
		
		{if $scenes || $category->description || $category->id_image}
		<div class="content_scene_cat well-white">
			{if $scenes}
				<!-- Scenes -->
		...
		{if $products}
			<div class="content_sortPagiBar">
				...
				<div class="sortPagiBar row">
					<div class="span4">{include file="./product-sort.tpl"}</div>
					<div class="span4">{include file="./product-compare.tpl"}</div>
					<div class="span4">{include file="./nbr-product-page.tpl"}</div>
				</div>
			</div>
